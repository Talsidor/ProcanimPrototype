...
//----------------------------------------------
// Modified by Cardboard Keep to function without the rest of the NGUI framework, sorry Michael!
using UnityEngine;
using UnityEditor;
...
public class NGUITransformInspector : Editor
{
	...
	{
		EditorGUIUtility.labelWidth = 15f; // SetLabelWidth(15f);
